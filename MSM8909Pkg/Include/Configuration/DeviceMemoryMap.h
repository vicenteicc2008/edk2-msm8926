...
{0x87900000, 0x00300000, "TZ Apps",          AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, DEVICE},
{0x87C00000, 0x000E0000, "MPSS_EFS / SBL",   AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, DEVICE},
{0x87CE0000, 0x00020000, "ADSP_EFS",         AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, DEVICE},
...
{0x87E80000, 0x00180000, "TZ QSEE",          AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, DEVICE},
{0x88000000, 0x06F00000, "PIL_REGION",       AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, DEVICE},
...
{0x08600000, 0x00004000, "IMEM Boot Base",   NoHob,  SYS_MEM, INITIALIZED, Conv,   DEVICE},
...
{0x00300000, 0x00200000, "REG 2",           AddDev, MMAP_IO,  UNCACHEABLE, MmIO,   DEVICE},
{0x00700000, 0x00D00000, "REG 3",           AddDev, MMAP_IO,  UNCACHEABLE, MmIO,   DEVICE},
{0x01400000, 0x00C00000, "REG 4",           AddDev, MMAP_IO,  UNCACHEABLE, MmIO,   DEVICE},
{0x02000000, 0x01C00000, "REG 5",           AddDev, MMAP_IO,  UNCACHEABLE, MmIO,   DEVICE},
